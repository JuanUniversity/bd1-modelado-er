...
ALTER TABLE calificacion_vendedor ADD CHECK ( calificacion BETWEEN 1 AND 5 );
...
ALTER TABLE detalle_pedido ADD CHECK ( precio_unitario > 0 );

ALTER TABLE detalle_pedido ADD CHECK ( descuento >= 0 );
...
ALTER TABLE envio ADD CHECK ( costo_envio >= 0 );
...
ALTER TABLE item_carrito ADD CHECK ( cantidad > 0 );
...
ALTER TABLE pago
    ADD
        CHECK ( metodo_pago IN ( 'billetera', 'efectivo', 'pse', 'tarjeta' ) );
...
ALTER TABLE pedido ADD CHECK ( total >= 0 );

ALTER TABLE pedido
    ADD
        CHECK ( estado IN ( 'cancelado', 'entregado', 'enviado', 'pagado', 'pendiente' ) );
...
ALTER TABLE producto ADD CHECK ( precio_actual > 0 );

ALTER TABLE producto ADD CHECK ( stock_disponible >= 0 );

ALTER TABLE producto
    ADD
        CHECK ( estado IN ( 'agotado', 'borrador', 'publicado', 'retirado' ) );
...
ALTER TABLE seguimiento
    ADD
        CHECK ( estado IN ( 'devuelto', 'en_preparacion', 'en_reparto', 'en_transito', 'entregado' ) );
...
ALTER TABLE valoracion_producto ADD CHECK ( calificacion BETWEEN 1 AND 5 );
